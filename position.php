...
if ($_SESSION['login_type'] == 2) {
	...
	</i> You do not have the required permission to view this page.</div>';
    exit();
}

// Rest of your existing position.php code...
?>
			...
			<form action="" id="manage-position">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3 btn-custom"> Save</button>
								<button class="btn btn-sm btn-default col-sm-3 btn-custom" type="button" onclick="_reset()"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_position btn-custom" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
